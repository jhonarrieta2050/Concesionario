 ...
 * @author jhon
 */
public class AccionComprar extends javax.swing.JFrame {

    private Formulario formulario;
    private VehiculoAgregados vehiculoAgregarUi = new VehiculoAgregados();
    public AccionComprar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccionComprar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccionComprar().setVisible(true);
            }
        });
    }
